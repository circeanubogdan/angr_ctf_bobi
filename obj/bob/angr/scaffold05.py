...
def main(argv):
  ...
  # (!)
  password0 = claripy.BVS('password0', 8)
  password1 = claripy.BVS('password1', 8)
  password2 = claripy.BVS('password2', 8)
  password3 = claripy.BVS('password3', 8)
